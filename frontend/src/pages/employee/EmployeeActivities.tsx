          ...
          myRecs.map(rec => (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-muted-foreground"><MapPin className="h-3.5 w-3.5" /> A definir</div>
                ...
                <div className="mt-3 flex items-center gap-4 rounded-lg bg-background p-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-muted-foreground italic">Merci de confirmer votre presence ou indiquer la cause de l absence.</p>
                  </div>
                </div>
